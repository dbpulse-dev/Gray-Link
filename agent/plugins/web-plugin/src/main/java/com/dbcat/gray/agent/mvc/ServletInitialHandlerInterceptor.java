 ...
 * @author Blackfost
 */
public class ServletInitialHandlerInterceptor implements InContextInterceptor, InstanceMethodsAroundInterceptor {
    ...
    private Context buildContext(Object[] allArguments) {
        ...
        return new Context() {
            ...
            public Object get(String key) {
                HeaderValues values = requestHeaders.get(key);
                if (values == null) {
                    return null;
                }
                return values.get(0);
