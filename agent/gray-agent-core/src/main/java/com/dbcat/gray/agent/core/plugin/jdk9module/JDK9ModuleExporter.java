...
package com.dbcat.gray.agent.core.plugin.jdk9module;

import com.dbcat.gray.agent.core.logging.api.ILog;
import com.dbcat.gray.agent.core.logging.api.LogManager;
import com.dbcat.gray.agent.core.plugin.ByteBuddyCoreClasses;
...
public class JDK9ModuleExporter {
    ...
    private static final String[] HIGH_PRIORITY_CLASSES = {
            ...
            "com.dbcat.gray.agent.core.plugin.interceptor.enhance.ConstructorInter",
            "com.dbcat.gray.agent.core.plugin.interceptor.enhance.InstMethodsInter",
            "com.dbcat.gray.agent.core.plugin.interceptor.enhance.InstMethodsInterWithOverrideArgs",
            "com.dbcat.gray.agent.core.plugin.interceptor.enhance.StaticMethodsInter",
            "com.dbcat.gray.agent.core.plugin.interceptor.enhance.StaticMethodsInterWithOverrideArgs",
    };
