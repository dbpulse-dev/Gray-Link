...
package com.dbcat.gray.agent.slf4j.impl;
 ...
 * <p>
 * Don't move this class to any other package, its package must be as same as the shaded com.dbx.gray.dependencies.org.slf4j.impl
 */
