 ...
 * @author Blackfost
 */
public class BatchAcknowledgingMessageListenerFilter<K, V> implements BatchAcknowledgingMessageListener<K, V> {


    private BatchMessageListener delegate;
    private boolean isGray;

    public BatchAcknowledgingMessageListenerFilter(BatchMessageListener delegate, boolean isGray) {
