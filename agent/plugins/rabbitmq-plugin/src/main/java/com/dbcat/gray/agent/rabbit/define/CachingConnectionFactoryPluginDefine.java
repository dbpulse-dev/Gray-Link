 ...
 * @author Blackfost
 */
public class CachingConnectionFactoryPluginDefine extends ClassInstanceMethodsEnhancePluginDefine {

    private static final String ENHANCE_CLASS = "org.springframework.amqp.rabbit.connection.CachingConnectionFactory";

    private static final String INTERCEPTOR_CLASS = "com.dbcat.gray.agent.rabbit.CachingConnectionFactoryInterceptor";
