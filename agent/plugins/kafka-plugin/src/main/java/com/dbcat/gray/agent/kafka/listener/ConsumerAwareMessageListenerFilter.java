 ...
 * @author Blackfost
 */
public class ConsumerAwareMessageListenerFilter<K, V> implements ConsumerAwareMessageListener<K, V> {


    private GenericMessageListener delegate;
    private boolean isGray;

    public ConsumerAwareMessageListenerFilter(GenericMessageListener delegate, boolean isGray) {
